...
ADMIN_PASSWORD=bigoptibase_admin
...
curl -ik -X POST -H "Authorization: bearer $token" -H "Content-type:application/json" -H "Accept:application/json" --data @bigoptirepo.json "$BDA_SERVER_PREFIX/datastore" && echo
