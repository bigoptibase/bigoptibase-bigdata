...
package gr.ntua.ece.cslab.bigoptibase.bda.analyticsml.runners;
...
import gr.ntua.ece.cslab.bigoptibase.bda.common.storage.connectors.PostgresqlConnector;
import gr.ntua.ece.cslab.bigoptibase.bda.datastore.beans.Job;
import gr.ntua.ece.cslab.bigoptibase.bda.datastore.beans.MessageType;
import gr.ntua.ece.cslab.bigoptibase.bda.datastore.beans.Recipe;
...
public class LivyRunner extends ArgumentParser implements Runnable {
    ...
    private String buildRecipePythonCode(DbInfo info, String args) throws SQLException, SystemConnectorException {
        ...
        if (this.job.getResultStorage().equals("kpidb")){
            ...
            Connector conn = Connector.getConnectorInfoById(info.getConnectorId());
