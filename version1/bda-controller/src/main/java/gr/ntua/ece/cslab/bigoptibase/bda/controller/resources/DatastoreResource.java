...
package gr.ntua.ece.cslab.bigoptibase.bda.controller.resources;

import gr.ntua.ece.cslab.bigoptibase.bda.analyticsml.RunnerInstance;
import gr.ntua.ece.cslab.bigoptibase.bda.common.Configuration;
import gr.ntua.ece.cslab.bigoptibase.bda.common.storage.SystemConnector;
import gr.ntua.ece.cslab.bigoptibase.bda.common.storage.SystemConnectorException;
import gr.ntua.ece.cslab.bigoptibase.bda.common.storage.beans.Connector;
import gr.ntua.ece.cslab.bigoptibase.bda.common.storage.beans.ExecutionEngine;
import gr.ntua.ece.cslab.bigoptibase.bda.common.storage.beans.ExecutionLanguage;
import gr.ntua.ece.cslab.bigoptibase.bda.common.storage.beans.DbInfo;
import gr.ntua.ece.cslab.bigoptibase.bda.common.storage.connectors.HDFSConnector;
import gr.ntua.ece.cslab.bigoptibase.bda.datastore.StorageBackend;
import gr.ntua.ece.cslab.bigoptibase.bda.datastore.beans.*;
 ...
 */
@RestController
@CrossOrigin(origins = {"https://bigoptibase.qubiteq.gr","http://localhost:3000"}, allowCredentials = "true")
